# -*- coding: utf-8 -*-
"""
Created on July 29 15:05:46 2020
...
mat = scio.loadmat('Data_in_mat\images_May2020_AllModels_30K_dist_part1_analytic_newUnc_newPS.mat')
images[0:30000,:,:]=mat.get('I_part1')
mat = scio.loadmat('Data_in_mat\images_May2020_AllModels_30K_dist_part2_merger_newUnc_newPS.mat')
images[30000:60000,:,:]=mat.get('I_part2')
mat = scio.loadmat('Data_in_mat\images_May2020_AllModels_30K_dist_part3_spiral_newUnc_newPS.mat')
...
mat = scio.loadmat('Data_in_mat\labels_May2020_AllModels_30K_dist_part1_analytic.mat')
...
mat = scio.loadmat('Data_in_mat\labels_May2020_AllModels_30K_dist_part2_merger.mat')
...
mat = scio.loadmat('Data_in_mat\labels_May2020_AllModels_30K_dist_part3_spiral.mat')
...
rand_lst=np.random.permutation(n1)
...
filepath="T_JJS_loss_3Models_weights-improvement_NewLoss_AB-{epoch:03d}-{val_loss:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='loss', verbose=1, save_best_only=True, mode='min', period=20)
callbacks_list = [checkpoint]


# load saved weights    
model_1.load_weights("Weights.hdf5")
...
# savetxt('errors_a.csv', er_a, delimiter=',')
# savetxt('lbl_mon_a.csv', lbl_mon_a, delimiter=',')

# savetxt('errors_b.csv', er_b, delimiter=',')
# savetxt('lbl_mon_b.csv', lbl_mon_b, delimiter=',')
